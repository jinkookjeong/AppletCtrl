...
public class ReceiveWindow implements MouseListener
{
  ...
  public ReceiveWindow(String url, String unikey, String to_id, ObjectConnection Ocon, XLogger logger, MessageMgr langMgr, String lang)
  {    
		this.url = url;
		this.unikey = unikey;
		this.to_id = to_id;
  ...
  public XmlConstant rcvXmlFile() throws IOException, Exception
  {
      doModal();
   ...
   public void setStatusMapMessage(String key)
   {
    ...
    {
	   ReceiveWindow sWin = new ReceiveWindow();	  
    }
}
