  ...
  if (browser == 'Mozilla' || browser == 'Netscape') {
	   TZApplet = '<embed id="CAPP"'+
	    ' width="50" height="50"'+
  ...
  {
   TZApplet = '<OBJECT id="CAPP"'+ 
   			'  classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"' +
		    '  WIDTH = "50" HEIGHT = "50"'+
		    '  codebase="http://localhost:8088/AppletCtrl/java/"'+
		    '  pluginspage="http://java.sun.com/javase/downloads"'+
		    '  tabindex="-1">'+
		    ' <PARAM NAME="CODE" VALUE = "com.ApplyTest" />'+
		    ' <PARAM NAME="java_arguments" value=" -Xmx512M "/>'+
		    ' <PARAM NAME="type" VALUE="application/x-java-applet;version=1.6" />'+
		  
		    ' <PARAM NAME="codebase_lookup" value="false"/>' +   
		    ' <PARAM NAME="archive" value="secuApp.jar" />'+
